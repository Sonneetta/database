...
namespace RGR
{
    public class ViewClass
    {
        ...
        public void GetAllEvent(List<TEvent> list)
        {
            ...
            {
                Console.WriteLine("|{0,3}|{1,20}|{2,20}|{3,6}|", e.ID, e.EventNameId, e.Theme, e.EventDate);
            }
            Console.WriteLine(" -------------------------------------------------------- ");
        }
        public void GetAllEventLocation(List<TEventLocation> list)
        {
            ...
            {
                Console.WriteLine("|{0,3}|{1,25}|{2,25}|", e.ID, e.EventId, e.LocationId);
            }
            Console.WriteLine(" -------------------------------------------------------- ");
        }
        ...
        public void GetAllLocation(List<TLocation> list)
        {
            ...
            {
                Console.WriteLine("|{0,3}|{1,25}|{2,30}|{3,5}|{4,25}|", e.ID, e.Name, e.Address, e.NumberOfSeats, e.OwnerId);
            }
            Console.WriteLine(" --------------------------------------------------------------------------------------------- ");
        }
        public void GetAllOwner(List<TOwner> list)
        {
            ...
            {
                Console.WriteLine("|{0,3}|{1,25}|{2,15}|", e.ID, e.Name, e.PhoneNumber);
            }
            Console.WriteLine(" ---------------------------------------------- ");
