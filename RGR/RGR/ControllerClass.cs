            ...
            while (true)
            {
                ...
                else if (key1.Key == ConsoleKey.D1)
                {
                    ...
                    else if (key2.Key == ConsoleKey.D2)
                    {
                        ...
                        TEvent e = new TEvent();
                        view.PrintMessage(" Name Id: ");
                        e.EventNameId = Convert.ToInt32(Console.ReadLine());
                    ...
                    if (key2.Key == ConsoleKey.D5)
                    {
                        ...
                        if (key3.Key == ConsoleKey.D1)
                        {
                            ...
                            view.GetAllEvent(model.SearchEventByName(nameId));
                        }
                ...
                else if (key1.Key == ConsoleKey.D2)////////////////////////////////////////////////
                {
                    ...
                    else if (key2.Key == ConsoleKey.D2)
                    {
                        ...
                        o.PhoneNumber = Console.ReadLine();
                ...
                else if (key1.Key == ConsoleKey.D3)
                {
                    ...
                    else if (key2.Key == ConsoleKey.D2)
                    {
                        ...
                        location.OwnerId = Convert.ToInt32(Console.ReadLine());
                ...
                else if (key1.Key == ConsoleKey.D5)
                {
                    ...
                    if (key2.Key == ConsoleKey.D5)
                    {
                        ...
                        if (key3.Key == ConsoleKey.D1)
                        {
                            view.PrintMessage("  Enter Event name id:");
                            string name = Console.ReadLine();
                            view.GetAllEventLocation(model.SearchEventLocationByEvent(Convert.ToInt32(name)));
                        }
                        else if (key3.Key == ConsoleKey.D2)
                        {
                            view.PrintMessage("  Enter Location name id:");
                            string name = Console.ReadLine();
                            view.GetAllEventLocation(model.SearchEventLocationByLocation(Convert.ToInt32(name)));
                        }
